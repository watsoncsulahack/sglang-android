...
def update_sliding_window_buffer(
    ...
    window_kv_indices=None,
    skip_full_to_swa_translate=False,
):
    ...
    ``skip_full_to_swa_translate=True`` leaves ``window_kv_indices`` as VIRTUAL
    ...
    if not skip_full_to_swa_translate and hasattr(
